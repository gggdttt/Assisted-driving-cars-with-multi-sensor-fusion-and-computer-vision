...
* **1.3.4.2**  nodejs的安装
  ...
  * 解压并安装 Node.js
  ...
  到这里为止，我们已经完成在 Raspbian 系统上安装 Node.js 了。树莓派3B Raspbian系统安装 Node.js 10
...
![img](https://pic1.zhimg.com/80/v2-1f26296f221bd54e7c3061f8114d7c84_720w.jpg)
...
![img](https://pic3.zhimg.com/80/v2-e4723d678f41a2603111e0959f0ddab6_720w.jpg)
...
\2. 运行 **gpio -v** 检查是否已安装 wiringPi。没有的话，安装 [Wiring Pi](https://link.zhihu.com/?target=http%3A//wiringpi.com/download-and-install/)。

...
#### **1.3.1** 打开`darknet.sln`,应该会弹出如下图所示界面，如果没有就在选项卡中 项目–重定向打开，特别注意平台工具集选择无升级，且**SDK版本要选择具体的版本，不能选`最新版`**，否则选了编译会有报错。
[<img src="pic\KkePSJ.png" alt="KkePSJ.png" style="zoom:80%;" />](https://imgchr.com/i/KkePSJ)

#### **1.3.2** 同时打开选项卡 调试–darknet属性修改项目属性。
